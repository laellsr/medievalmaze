...
class Stone(Tile):
    def __init__(self, x, y):
        super().__init__(x, y)
        self.image = pygame.image.load('MedievalMaze/assets/objects/Brick_01.png')
...
class Greenery(Tile):
    def __init__(self, x, y):
        super().__init__(x, y)
        self.image = pygame.image.load('MedievalMaze/assets/objects/greenery_2.png')
...
class Plaque(Tile):
    def __init__(self, x, y):
        super().__init__(x, y)
        self.image = pygame.image.load('MedievalMaze/assets/objects/Sign_01.png')
...
class Barrel(Tile):
    def __init__(self, x, y):
        super().__init__(x, y)
        self.image = pygame.image.load('MedievalMaze/assets/objects/decor_17.png')
...
class Statue(Tile):
    def __init__(self, x, y):
        super().__init__(x, y)
        self.image = pygame.image.load('MedievalMaze/assets/objects/Decor_Statue.png')
...
class Goblin(Tile):
    def __init__(self, x, y):
        super().__init__(x, y)
        self.image = pygame.image.load('MedievalMaze/assets/goblin/goblin_11.png')
